    ...
    <div className="flex flex-col items-center">
      <div className="h-[75vh] md:h-[70vh] lg:h-[68vh] min-h-[550px] flex flex-col items-center justify-center text-center gap-6">
        ...
        <h1 className="text-4xl font-bold md:text-5xl">
          Optimiza la gestión de tu restaurante con{" "}
          <span className="text-primary">Mesa 360</span>
        </h1>
        <p className="text-lg md:text-xl max-w-2xl text-muted-foreground">
          El sistema POS definitivo para restaurantes en Argentina. Controla
          mesas, pedidos y empleados en tiempo real.
        </p>
      ...
      <div className="flex flex-col items-center gap-[2rem] sm:gap-[5rem]">
          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center">
            ...
            <div className="max-w-sm p-6 bg-card text-card-foreground rounded-md shadow-md">
              ...
              <p className="text-sm mt-2 text-muted-foreground">
                Crea y gestiona un mapa en tiempo real para optimizar el espacio
                de tu restaurante.
              </p>
            </div>
            {/* Tarjeta 2 */}
            <div className="max-w-sm p-6 bg-card text-card-foreground rounded-md shadow-md">
              ...
              <p className="text-sm mt-2 text-muted-foreground">
                Envía comandas en tiempo real a cocina y minimiza errores en los
                pedidos.
              </p>
            </div>
            {/* Tarjeta 3 */}
        ...
        <div className="w-full max-w-4xl mt-16 text-center">
          <h2 className="text-3xl font-semibold mb-4">
            ¡Únete a Mesa 360 Hoy Mismo!
          </h2>
          <p className="text-muted-foreground mb-8">
            Regístrate ahora y empieza a mejorar la administración de tu
